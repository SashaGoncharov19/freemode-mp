...
impl ImageOptionalHeader64 {
    fn import_dir_rva(&self) -> u32 {
        ...
        let ptr = self as *const ImageOptionalHeader64 as *const u8;
        *(ptr.add(data_dir_offset + (IMAGE_DIRECTORY_ENTRY_IMPORT * 8))) as u32
    }
}
...
pub fn hook_imports_in_module(
    ...
    unsafe {
        ...
        let _import_dir_rva = optional_header.size_of_headers; // This is not correct, but we need a different approach
